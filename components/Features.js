...
export default function Features() {
  return (
    <div id="features" className="max-w-7xl px-6 mx-auto">
      <div>
        ...
        <div class="mt-12 grid divide-x divide-y divide-gray-100 dark:divide-gray-700 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-3 lg:divide-y-0 xl:grid-cols-3">
          <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div class="relative space-y-8 py-12 p-8">
              ...
              <div class="space-y-2">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                  Gain a deeper understanding of how digital content influences
                  your child&apos;s development, fostering a balanced and
                  healthy media diet.
                </p>
              </div>
              <Link
          ...
          <div class="group relative bg-white dark:bg-gray-800 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div class="relative space-y-8 py-12 p-8">
              ...
              <div class="space-y-2">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                  Stay informed with brief, insightful summaries of the videos
                  your child watches, saving you time while keeping you
                  connected.
                </p>
              </div>
              <Link
          ...
          <div class="group relative bg-gray-50 dark:bg-gray-900 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
            <div class="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
              ...
              <div class="space-y-2">
                ...
                <p class="text-gray-600 dark:text-gray-300">
                  Understand the creators shaping your child&apos;s views,
                  ensuring they&apos;re following positive and enriching
                  influencers.
                </p>
              </div>
              <Link
