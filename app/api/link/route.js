...
async function fetchUserInfo(access_token) {
  // Define the endpoint for fetching the user info
  const userInfoEndpoint =
    "https://www.googleapis.com/oauth2/v1/userinfo?alt=json";

  // Make a GET request to the user info endpoint with the access token in the Authorization header
...
export async function POST(request) {
  try {
    ...
    // If the YouTube data is at least 5 days old, fetch new data
